        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" style="color:#f05f40;" href="#services">สถานะคอร์สเรียน</a></li>
                    <!-- Authentication Links -->
                    @guest
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" style="color:#f05f40;" href="{{ route('login') }}">ลงชื่อเข้าใช้งาน</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" style="color:#f05f40;" href="{{ route('register') }}">สมัครสมาชิก</a></li>
                    @else
                        <li class="nav-item">
